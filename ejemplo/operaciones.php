   ...
   switch($_GET['opc']){
      ...
      case 6://MODIFICA USUARIO SELECCIONADO
       ...
       case 11:
           ...
           $sql="select * from usuarios where nombre like'%".$_GET['txtBucador']."%' or primer_apellido like'%".$_GET['txtBucador']."%' or segundo_apellido like'%".$_GET['txtBucador']."%' or usuario like'%".$_GET['txtBucador']."%' or cargo like'%".$_GET['txtBucador']."%';";
           //print $sql;
           $c->tblUsuario($sql);
           break;
       case 14:
