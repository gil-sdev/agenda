...
';
            ...
            $content='
                <div class="form-group">
                     ...
                     <input id="txtDep" type="text" class="form-control" placeholder="Departamento" name="txtDep" value="">
                </div>
                ';
            $icon='<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>';
            ...
            $content='
                    <div class="form-group">
                         <input id="txtAddDep" type="text" class="form-control" placeholder="Departamento" name="txtDep">
                    </div>
                ';
